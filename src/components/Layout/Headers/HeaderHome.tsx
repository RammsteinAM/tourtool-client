...
const Header = (props: Props) => {
    ...
    const handleImportTournamentOpen = () => {
        setImportDialogOpen(true)
    };

    const handleImportTournamentClose = () => {
    ...
    return (
        <Toolbar className={classes.headerHomeRoot}>
            <div className={classes.headerHomeRow}>
                ...
                <Tooltip title={`${t("Import Tournament")}`}>
                    <IconButton className={classes.iconButton} aria-label="shuffle-players" onClick={handleImportTournamentOpen}>
                        <PublishIcon />
                    </IconButton>
                </Tooltip>
                <Button
            ...
            <TournamentImportDialog open={importDialogOpen} onClose={handleImportTournamentClose} />
        </Toolbar>
    )
}
