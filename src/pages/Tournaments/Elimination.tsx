...
const Elimination = (props: Props) => {
    ...
    const submitPlayersToStore = (players: StatePlayers) => {
        const storePlayers: StatePlayers = players
    ...
    const renderCards = (columnNumber: number) => {
        ...
        for (let i = numberOfGames; i >= 1; i--) {
            ...
            const p1 = players[columnNumber] && players[columnNumber][(numberOfGames - i) * 2]
